...
use Kpicaza\ExamBundle\Form\Type\FilterFormType;
use Kpicaza\ExamBundle\Form\Model\FilterFormModel;

/**
 * QuestionHandler
 * 
 */
class QuestionHandler implements QuestionHandlerInterface
{
    ...
    public function getList(array $parameters)
    {
        ...
        $form = $this->formFactory->create(new FilterFormType(), new FilterFormModel());
